    ...
    public class HttpsClientHandlerService : IHttpsClientHandlerService
    {
        public HttpMessageHandler GetPlatformMessageHandler()
        {
            ...
            handler.ServerCertificateCustomValidationCallback = (message, cert, chain, errors) =>
            {
                ...
                //if (cert != null && cert.Issuer.Equals("CN=psutrobon.com"))
                //if (cert != null && cert.Issuer.Equals("CN=https://www.psutrobon.com/gis_bssm/index.php?table=todoRest"))
                return true;
        ...
        private sealed class CustomHostnameVerifier : Java.Lang.Object, Javax.Net.Ssl.IHostnameVerifier
        {
            public bool Verify(string hostname, Javax.Net.Ssl.ISSLSession session)
            {
                return Javax.Net.Ssl.HttpsURLConnection.DefaultHostnameVerifier.Verify(hostname, session) ||
                    ...
                    hostname == "10.0.2.2" && session.PeerPrincipal?.Name == "CN=https://www.psutrobon.com/gis_bssm/index.php?table=todoRest";
            }
        }
    }
#elif IOS
